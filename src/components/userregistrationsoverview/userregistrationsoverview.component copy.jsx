                    ...
                    <table className='registrationtable'>
                        {registrations.map((r) => (
                            <tr>
                                ...
                                <td className='user-profile-reg-list__name'>{r?.church.name}</td>
                                <td className='user-reg-overview__city'>{r?.church?.city}, {r?.church?.stateProv}</td>
                                <td className='user-reg-overview__cancel-button'>
                                    <Link
                                        onClick={() => {
