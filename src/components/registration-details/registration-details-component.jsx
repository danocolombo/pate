...
const RegistrationDetails = ({
  ...
  const [homeState, setHomeState] = useState(currentUser?.residence?.stateProv);
    ...
    <>
      <div className="registrationdetailswrapper">
        ...
        <div className="eventbox" id="eventbox-location">
          <div className="registrationchurchname">{displayThis?.name}</div>
            ...
            <div className="registrar-data">
              <div className="registration-instructions">
                {currentUser?.isLoggedIn ? (
                  <>
                    <div>
                      You can change the information, if you are registering
                      someone else.
                    </div>
                  </>
                ) : (
                  <>
                    <div>
                      ...
                      an account to save your profile for future use.
                    </div>
                  </>
                )}
              </div>
              <div className="profilehomesection">Contact - Information</div>
              ...
              <div className="attendeewrapper">
                <label className="attendee-label" htmlFor="attendeeCount">
                  Attendees
                </label>
                <input
                  type="number"
              ...
              <div className="meal-wrapper">
                <p className="meal-description-label">
                  This event offers a "free" lunch at 12 noon, please indicate
                  how many will attend the lunch.
                </p>
                <label className="meal-count-label" htmlFor="mealCount">
                  Meal Guests
                </label>
