...
const Serve = ({
  ...
  const handleSubmitClick = async (event) => {
    ...
    if (
      ...
      printObject("SEP:886==>contactUpdates:\n", contactUpdates);
    }
    ...
    if (
      ...
      printObject("SEP:902==>locationUpdates:\n", locationUpdates);
    }
    ...
    if (rallyEvent.meal === null) {
      ...
      printObject("SEP:928==>mealUpdates:\n", mealUpdates);
    } else {
      if (
      ...
      printObject("SEP:942==>mealUpdates:\n", mealUpdates);
    }
