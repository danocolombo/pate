...
const Serve = ({
  ...
  const pastEvent = () => {
    ...
    //make numeric date
    let tDay = parseInt(currentDay);
    tDay = tDay + parseInt(currentMonth) * 100;
    tDay = tDay + parseInt(currentYear) * 10000;
  ...
  const handleChange = (e) => {
    ...
    switch (name) {
      ...
      case "mealsServed":
          //=====================================
        //this value is only edittable if
        //it is the day of the event or later
        //=====================================
        if (pastEvent()) {
            setMealsServed(value);
          } else {
            alert("can only be updated after the event");
          }
        break;
      case "mealMessage":
            ...
            <div className="serve-event-content-wrapper">
              <div className="registerform">
                <form>
                  ...
                  {/** church contact info */}
                  <div className="church-contact-header">Church Contact</div>
                  <div>
                  ...
                  {/** logisitics info */}
                  <div className="logistics-header">Logistics</div>
                  <div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="pending">{STATUS_VALUE[1]}</option>
                      <option value="rejected">{STATUS_VALUE[2]}</option>
                      <option value="available">{STATUS_VALUE[3]}</option>
                      <option value="offered">{STATUS_VALUE[4]}</option>
                      <option value="archived">{STATUS_VALUE[5]}</option>
                    </select>
                  </div>
                  {/** meal info */}
                  <div className="meal-header">Meal Details</div>
                  <div>
                    <label htmlFor="mealTime">Start Time</label>
                    <input
                      type="text"
                      id="mealTime"
                      name="mealTime"
                  ...
                  <div>
                    <label htmlFor="mealCount">Planned</label>
                    <input
                      type="number"
                      id="mealCount"
                      name="mealCount"
                  ...
                  <div>
                    <label htmlFor="mealsServed">Served</label>
                    <input
                      type="number"
                      id="mealsServed"
                      name="mealsServed"
                  ...
                  <div>
                    <label htmlFor="mealMessage">Message</label>
                    <input
                      type="memo"
                      id="mealMessage"
                      name="mealMessage"
                  ...
                  {/** logisitics info */}
                  <div className="tally-header">Tally Information</div>
                  <div>
