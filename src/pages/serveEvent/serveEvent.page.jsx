    ...
    if (graphicFileObj?.name) {
      ...
      if (graphicFileObj.name !== previousGraphicFile) {
        ...
        if (previousGraphicFile !== "tbd.png") {
          let fileToDelete = "events/" + eventID + previousGraphicFile;
          try {
        ...
        <div className="serveevent-page__form-box">
          ...
          <div className="serveevent-page__data-input-box">
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Church:</div>
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Street:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="text"
                  id="street"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">City:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="text"
                  id="city"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">State:</div>
              <div className="serveevent-page__grid-control">
                <SelectStateProv
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Postal Code:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="text"
                  id="postalCode"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Name:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="text"
                  id="contactName"
            ...
            <div className="serveevent-page__data-row-phone">
              <PhoneInput
                ...
                disableDropdown
                value={contactPhone}
                onChange={(contactPhone) => setContactPhone(contactPhone)}
                inputProps={{
                  padding: 0,
                  name: "Cell",
                  margin: 0,
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Email:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="text"
                  id="contactEmail"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Date:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="date"
                  id="rallyDate"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Start Time:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="time"
                  id="eventStart"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">End Time:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="time"
                  id="eventEnd"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Message:</div>
              <div className="serveevent-page__grid-control">
                <textarea
                  rows="4"
                  cols="18"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Approved:</div>
              <div className="serveevent-page__grid-control">
                ...
                isApproved ? (
                  <span className="serve-event-page__approval-true">TRUE</span>
                ) : (
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Cost:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="text"
                  id="mealCost"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Planned:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="number"
                  id="mealCount"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Served:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="number"
                  id="mealsServed"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Deadline:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="date"
                  id="mealDeadline"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Registrations:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="number"
                  id="registrations"
            ...
            <div className="serveevent-page__grid-data-box">
              <div className="serveevent-page__grid-label">Attendees:</div>
              <div className="serveevent-page__grid-control">
                <input
                  type="number"
                  id="attendees"
