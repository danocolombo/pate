        ...
        <>
          <div className="registrationdetailswrapper">
            ...
            <div className="eventbox" id="eventbox-location">
              ...
              <div>
                {theEvent?.details?.city},{theEvent?.details?.stateProv}&nbsp;
              ...
              <form>
                <div className="registrar-data">
                    ...
                    {currentUser?.isLoggedIn ? (
                      <>
                        <div className="register-fill-offer">
                          Click <span className="register-fill-click-here" onClick={populateUserInfo}>here</span> to populate with your information.
                        </div>
                      </>
                    ) : (
                      <>
                  ...
                  <div className="register-identity-wrapper">
                    ...
                    <div className="register-address-label">Address</div>
                    ...
                    <div>
                      <label htmlFor="churchStateProv">State</label>
                      <input
                        type="text"
                        id="churchStateProv"
