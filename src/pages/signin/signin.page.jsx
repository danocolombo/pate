...
const SignIn = ({
  ...
  const signIn = async () => {
    ...
    try {
      ...
      const userIsRegistered = await saveUser(currentUserInfo, currentSession);
  ...
  const saveUser = async (userInfo, userSession) => {
    ...
    if (dbUser === undefined) {
      ...
      userDetails.isLoggedIn = true;
      userDetails.affiliate = dbUser?.affiliations?.active?.value || "CRP8";
          ...
          <div className="signin-page__content-box">
            ...
            <div className="signin-page__section-box">
              <div className="signin-page__data-line">
                <div className="signin-page__data-label">Username</div>
              ...
              <div className="signin-page__data-line">
                <div className="signin-page__data-label">Password</div>
                <div className="signin-page__data-control">
                  <input
                    type="password"
                    id="password"
