...
const Serve = ({
  ...
  const [eventRegion, setEventRegion] = useState("east");
  ...
  const setDefaultEvent = async () => {
    ...
    dateToday = y + "-" + m + "-" + d;
    dateToday = "2023-01-20";
    setEventDate(dateToday);
    setEventRegion(currentUser?.eventRegion || "east");
    setAffiliate(currentUser?.affiliate || "CRP8");
    setChurchName("");
    setStreet("");
    setCity("");
      ...
      <div className="newevent-page__wrapper">
        <div className="newevent-page__form-box">
          ...
          <div className="newevent-page__data-input-box">
            <div className="newevent-page__section-header">Location</div>

            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Church:</div>
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Street:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="text"
                  id="street"
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">City:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="text"
                  id="city"
            ...
            {/*
                        ...
                        */}
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">State:</div>
              <StateProv
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Postal Code:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="text"
                  id="postalCode"
            ...
            <div className="newevent-page__section-header">Church Contact</div>

            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Name:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="text"
                  id="contactName"
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Email:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="text"
                  id="contactEmail"
            ...
            <div className="newevent-page__section-header">Logistics</div>

            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Date:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="date"
                  id="rallyDate"
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Start Time:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="time"
                  id="eventStart"
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">End Time:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="time"
                  id="eventEnd"
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Message:</div>
              <div className="newevent-page__grid-control">
                <textarea
                  rows="4"
                  cols="18"
            ...
            <div className="newevent-page__section-header">Meal Details</div>
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Cost:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="text"
                  id="mealCost"
            ...
            <div className="newevent-page__grid-data-box">
              <div className="newevent-page__grid-label">Deadline:</div>
              <div className="newevent-page__grid-control">
                <input
                  type="date"
                  id="mealDeadline"
