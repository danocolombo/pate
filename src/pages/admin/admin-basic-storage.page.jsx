...
const BasicStorage = ({
    ...
    const getBucketList = async () => {
        ...
        try {
            const s3File = {
                objectURL: 'https://pate20213723ed06531948b6a5a0b14d1c3fb499175248-dev.s3.amazonaws.com/P8-NewnanGA-20210424.png',
                key: 'P8-NewnanGA-20210424.png',
                s3URI: 's3://pate20213723ed06531948b6a5a0b14d1c3fb499175248-dev/P8-NewnanGA-20210424.png',
                arn: 'arn:aws:s3:::pate20213723ed06531948b6a5a0b14d1c3fb499175248-dev/P8-NewnanGA-20210424.png'
            }
            const s3FileName = 'P8-NewnanGA-20210424.png';
            const fileAccessURL = await Storage.get(s3FileName);
